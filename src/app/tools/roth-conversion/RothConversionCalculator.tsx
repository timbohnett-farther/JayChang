...
function getBrackets(filing: string): Bracket[] {
  return filing === 'single' ? BRACKETS_SINGLE : BRACKETS_MFJ
}

function computeTax(income: number, filing: string): number {
...
function getMarginalBracket(income: number, filing: string): number {
    ...
    <div className="px-5 py-10 max-w-[1100px] mx-auto">
            ...
            <>
              ...
              <div className="bg-white rounded-[12px] border border-[#E2E8F0] p-8 mb-6 text-center">
                ...
                <p className="font-sans text-[15px] text-[#5b6a71] mt-2 max-w-[500px] mx-auto">
                  ...
                  impact, IRMAA thresholds, and RMD strategies &mdash; tailored to your
      ...
      <div className="mt-10 max-w-[900px] mx-auto space-y-3">
        <p className="font-sans text-[11px] text-[#6B7280] leading-relaxed">
          ...
          calculator uses 2025 federal income tax brackets; future tax law
