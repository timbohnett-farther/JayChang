...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/dallas`, lastModified: '2026-03-16', changeFrequency: 'monthly' as const, priority: 0.9 },
    ...
    { url: `${baseUrl}/insights/dallas-wealth-management-guide`, lastModified: '2026-03-10', changeFrequency: 'monthly' as const, priority: 0.6 },
    ...
    { url: `${baseUrl}/insights/selling-business-dallas`, lastModified: '2026-03-10', changeFrequency: 'monthly' as const, priority: 0.6 },
